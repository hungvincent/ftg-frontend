...
$(".btn-add-lianghuangfield").click(function(){
    ...
    // 法會開始日
    let params_lianghuang_pujaStart = "<td><input class='table_input params_lianghuang_pujaStart' type='date'></td>";

    // 法會結束日
    let params_lianghuang_pujaEnd = "<td><input class='table_input params_lianghuang_pujaEnd' type='date'></td>";

    // 開始登記日期
    let params_lianghuang_registerStart = " <td><input class='table_input params_lianghuang_registerStart' type='date'></td>";

    // 結束登記日期
    let params_lianghuang_registerEnd = "<td><input class='table_input params_lianghuang_registerEnd' type='date'></td>";
    ...
    let lianghuangField_table = $("<tr></tr>");
