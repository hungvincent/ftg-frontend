...
$(".btn-add-godStarkind").click(function(){
    ...
    // 數量
    let params_godStar_num = "<td><div class='d-flex input-num'><div class='params_godStar_num me-2'><label>總數</label><input class='table_input params_godStar_num-total' type='number'></div><div class='params_godStar_num me-2'><label>臨櫃數</label><input class='table_input params_godStar_num-counter' type='number'></div><div class='params_godStar_num me-2'><label>網路數</label><input class='table_input params_godStar_num-net' type='number'></div></div></td>";
    ...
    godStarKind_table.append(table_num,params_godStar_kindname,params_godStar_num,params_godStar_price,btn_box);
