...
$(".btn-add-pilgrimagefield").click(function(){
    ...
    // 法會開始日
    let params_pilgrimage_pujaStart = "<td><input class='table_input params_pilgrimage_pujaStart' type='date'></td>";

    // 法會結束日
    let params_pilgrimage_pujaEnd = "<td><input class='table_input params_pilgrimage_pujaEnd' type='date'></td>";

    // 開始登記日期
    let params_pilgrimage_registerStart = " <td><input class='table_input params_pilgrimage_registerStart' type='date'></td>";

    // 結束登記日期
    let params_pilgrimage_registerEnd = "<td><input class='table_input params_pilgrimage_registerEnd' type='date'></td>";
    ...
    let pilgrimageField_table = $("<tr></tr>");
