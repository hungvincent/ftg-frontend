...
$(".btn-add-constructionkind").click(function(){
    ...
    // 開始登記日期
    let params_construction_startdate = " <td><input class='table_input input-date params_construction_startdate' type='date'></td>";

    // 結束登記日期
    let params_construction_enddate = "<td><input class='table_input input-date params_construction_enddate' type='date'></td>";
