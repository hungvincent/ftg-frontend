...
$(".btn-add-lightfield").click(function(){
    ...
    // 序號
    let table_num = $("<td class='params_lightField_index'></td>");
    $(document).ready(function(){
        $(".params_lightField_index").each(function(i){
            let num = i+1;
            $(this).text(num);
        })
    })
    ...
    // 法會開始日
    let params_light_pujaStart = "<td><input class='table_input input-date params_light_pujaStart' type='text'></td>";

    // 法會結束日
    let params_light_pujaEnd = "<td><input class='table_input input-date params_light_pujaEnd' type='text'></td>";

    // 開始登記日期
    let params_light_registerStart = " <td><input class='table_input input-date params_light_registerStart' type='text'></td>";

    // 結束登記日期
    let params_light_registerEnd = "<td><input class='table_input input-date params_light_registerEnd' type='text'></td>";
    ...
    let lightField_table = $("<tr class='editing'></tr>");
    ...
    lightField_table.insertAfter(".table-params_light-field .table_title");
})
