...
$(".btn-add-stopfield").click(function(){
    ...
    // 法會開始日
    let params_stop_pujaStart = "<td><input class='table_input params_stop_pujaStart' type='date'></td>";

    // 法會結束日
    let params_stop_pujaEnd = "<td><input class='table_input params_stop_pujaEnd' type='date'></td>";

    // 開始登記日期
    let params_stop_registerStart = " <td><input class='table_input params_stop_registerStart' type='date'></td>";

    // 結束登記日期
    let params_stop_registerEnd = "<td><input class='table_input params_stop_registerEnd' type='date'></td>";

    // 可報名戶數
    let params_stop_num = "<td><div class='d-flex input-num'><div class='params_stop_num me-2'><label>總數</label><input class='table_input params_stop_num-total' type='number'></div><div class='params_stop_num me-2'><label>臨櫃數</label><input class='table_input params_stop_num-counter' type='number'></div><div class='params_stop_num me-2'><label>網路數</label><input class='table_input params_stop_num-net' type='number'></div></div></td>";
    ...
    let stopField_table = $("<tr></tr>");
    stopField_table.append(table_num, params_stop_fieldnum, params_stop_pujaStart, params_stop_pujaEnd, params_stop_registerStart,params_stop_registerEnd, params_stop_num , params_stop_price,btn_box );
