...
$(".btn-add-lightkind").click(function(){
    ...
    // 數量
    let params_light_num = "<td><div class='d-flex input-num'><div class='params_light_num me-2'><label>總數</label><input class='table_input params_light_num-total' type='number'></div><div class='params_light_num me-2'><label>臨櫃數</label><input class='table_input params_light_num-counter' type='number'></div><div class='params_light_num me-2'><label>網路數</label><input class='table_input params_light_num-net' type='number'></div></div></td>";
    ...
    lightKind_table.append(table_num,params_light_kindname,params_light_num,params_light_price,btn_box);
