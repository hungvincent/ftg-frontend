...
$(".btn-add-lianghuangkind").click(function(){
    ...
    // 數量
    let params_lianghuang_num = "<td><div class='d-flex input-num'><div class='params_lianghuang_num me-2'><label>總數</label><input class='table_input params_lianghuang_num-total' type='number'></div><div class='params_lianghuang_num me-2'><label>臨櫃數</label><input class='table_input params_lianghuang_num-counter' type='number'></div><div class='params_lianghuang_num me-2'><label>網路數</label><input class='table_input params_lianghuang_num-net' type='number'></div></div></td>";
    ...
    lianghuangKind_table.append(table_num,params_lianghuang_kindname,params_lianghuang_num,params_lianghuang_price,btn_box);
