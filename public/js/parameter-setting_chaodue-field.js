...
$(".btn-add-chaoduefield").click(function(){
    ...
    // 法會開始日
    let params_chaodue_pujaStart = "<td><input class='table_input params_chaodue_pujaStart' type='date'></td>";

    // 法會結束日
    let params_chaodue_pujaEnd = "<td><input class='table_input params_chaodue_pujaEnd' type='date'></td>";

    // 開始登記日期
    let params_chaodue_registerStart = " <td><input class='table_input params_chaodue_registerStart' type='date'></td>";

    // 結束登記日期
    let params_chaodue_registerEnd = "<td><input class='table_input params_chaodue_registerEnd' type='date'></td>";
